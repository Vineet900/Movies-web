...
const PersonDetails = () => {
  ...
  return info ? (
    <div className="px-[10%] h-[150vh] w-screen bg-[#14131d] ">
      {/* Part-1 navigation */}
      ...
      <div className="w-full flex">
        ...
        <div className="w-[20%]">
          <img
            className="shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] h-[38vh] object-cover"
        ...
        <div className="w-[80%] ml-[5%]">
          ...
          <div className="list-disc text-zinc-400 mt-5 w-full h-[50vh] overflow-x-hidden overflow-y-auto shadow-lg shadow-[rgba(255,255,255,.3)] border-2 border-zinc-700 p-5">
